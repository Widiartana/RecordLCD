...
export default class Tambah extends React.Component {
    ...
    Insert_Data_Into_MySQL = () =>
    {
        ...
        {
            fetch('http://gusnando.com/mobile/widiartana/tambahlcd.php',
            {
                method: 'POST',
                headers:
                {
      ...
      return (
        <View style = {{flex:1, backgroundColor:'#e6ffff'}}>
          ...
          <View style={{margin:20, padding: 10, backgroundColor:'#BBDEFB', borderRadius:3}}>
              <TextInput style = {{height: 50, fontSize: 14, color:'black'}}
              ...
              <TextInput style = {{height: 50, color:'black' }}
                ...
                keybordType = 'numeric'
              />
              <Button title="PINJAM SEKARANG" onPress={this.Insert_Data_Into_MySQL} color="orange" />
                 </View>
         </View>
      );
    }
